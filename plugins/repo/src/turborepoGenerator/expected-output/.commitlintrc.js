    ...
    questions: {
      type: {
        ...
        enum: {
          ...
          fix: {
            description:
              '🐛 any change to an unintended behavior that affects consumers',
            title: 'fix',
          },
          feat: {
            description:
              '✨ any new change in features or behavior that affects consumers',
            title: 'feat',
          },
        },
      },
      ...
      subject: {
        description:
          'Finish this SHORT sentence (required): "Applying this commit will..."',
      },
      body: {
