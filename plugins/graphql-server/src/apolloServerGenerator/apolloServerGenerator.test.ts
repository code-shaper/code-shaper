...
import { apolloServerGenerator } from './index';

describe('apolloServerGenerator', () => {
  test('should create a new apolloServer from templates', async () => {
    ...
    // Run the generator
    await apolloServerGenerator.generate(testOutput, {
